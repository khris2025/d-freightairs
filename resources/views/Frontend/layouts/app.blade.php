   ...
   <body>
         ...
         <div class="inner">
            ...
            <div class="hide-mobile">
               ...
               <address class="address">
                  <!-- <p>+1 (850) 344 0 66<br> -->
                  <a href="#">support@swiftcargotransit.com</a></p>
               </address>
      ...
      <div class="topbar">
         <div class="container">
            ...
            <!-- end phone -->
            <div class="email"> Email: <a href="#">support@swiftcargotransit.com</a> </div>
            <!-- end email -->
      ...
      <footer class="footer">
         <div class="container">
            <div class="row">
               ...
               <!-- end col-4 -->
               <div class="col-12">
                  <div class="footer-bottom"> <span>© 2025 CARGO FREIGHT AIRS| Logicstic Shipping Company</span> </div>
                  <!-- end footer-bottom -->
               </div>
               <!-- end col-12 -->
            </div>
